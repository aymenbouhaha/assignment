...
export const ErrorComponent = ({ message = "Something went wrong. Please try again later." }: { message?: string }) => {
	return (
		<div className="flex flex-col gap-4 justify-center items-center bg-primary-red/5 border border-primary-red rounded-lg text-center shadow-drop-down h-[500px]">
