	...
	"inline-flex items-center justify-center rounded-md disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
	{
		variants: {
			variant: {
				...
				pagination:
					"transition-all duration-300 ease-in-out gap-3 text-p4 font-medium text-primary-purple border border-background hover:border-primary-purple hover:bg-[#fff]",
				restart: "bg-primary-red text-[#fff]",
			},
			size: {
				default: "h-9 py-2.5 w-full",
				pagination: "py-2 px-3",
			},
		},
		defaultVariants: {
			variant: "default",
